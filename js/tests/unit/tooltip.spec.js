...
describe('Tooltip', () => {
  ...
  describe('show', () => {
    ...
    it('should show a tooltip relative to placement option', done => {
      ...
      tooltipEl.addEventListener('inserted.bs.tooltip', () => {
        expect(tooltip.getTipElement()).toHaveClass('bs-tooltip-bottom')
      })

      tooltipEl.addEventListener('shown.bs.tooltip', () => {
        const tooltipShown = document.querySelector('.tooltip')

        expect(tooltipShown).toHaveClass('bs-tooltip-bottom')
        done()
      })
  ...
  describe('updateAttachment', () => {
    it('should use end class name when right placement specified', done => {
      ...
      tooltipEl.addEventListener('inserted.bs.tooltip', () => {
        expect(tooltip.getTipElement()).toHaveClass('bs-tooltip-end')
        done()
      })
    ...
    it('should use start class name when left placement specified', done => {
      ...
      tooltipEl.addEventListener('inserted.bs.tooltip', () => {
        expect(tooltip.getTipElement()).toHaveClass('bs-tooltip-start')
        done()
      })
